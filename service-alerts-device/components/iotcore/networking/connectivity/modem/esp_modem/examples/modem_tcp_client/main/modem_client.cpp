...
static void mqtt_event_handler(void *handler_args, esp_event_base_t base,
  ...
  case MQTT_EVENT_SUBSCRIBED:
    ...
    msg_id = esp_mqtt_client_publish(client, "/topic/esp-pppos", "esp32-pppos",
                                     0, 0, 0);
...
extern "C" void app_main(void) {
  ...
  dte_config.task_stack_size =
      CONFIG_EXAMPLE_MODEM_UART_EVENT_TASK_STACK_SIZE * 2;
  ...
  esp_modem_dce_config_t dce_config =
      ESP_MODEM_DCE_DEFAULT_CONFIG(CONFIG_EXAMPLE_MODEM_APN);
