...
/**
 * @brief This is a null-module, doesn't define any AT commands, just passes
 * everything to pppd
 */
...
public:
  ...
  bool setup_data_mode() override { return true; }

  bool set_mode(modem_mode mode) override { return true; }
...
void modem_stop_network() { NetModule::stop(); }
