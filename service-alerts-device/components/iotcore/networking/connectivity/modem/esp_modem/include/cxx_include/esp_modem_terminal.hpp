...
/**
 * @brief Terminal interface. All communication interfaces must comply to this
 * interface in order to be used as a DTE
 */
class Terminal {
public:
  ...
  /**
   * @brief Read from the terminal. This function doesn't block, but return all
   * available data.
