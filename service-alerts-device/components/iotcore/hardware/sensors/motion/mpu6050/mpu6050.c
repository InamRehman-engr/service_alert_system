...
void mpu6050_initialize(void) {
  ...
  xTaskCreateStaticPinnedToCore(
      vI2CWrite,            /* Function that implements the task. */
      ...
      0 /*  0 for PRO_CPU, 1 for APP_CPU, or tskNO_AFFINITY which allows the
           task to run on both */
  );

  xTaskCreateStaticPinnedToCore(
      vI2CRead,            /* Function that implements the task. */
  ...
  xTaskCreateStaticPinnedToCore(
      vMPU6050Task,        /* Function that implements the task. */
